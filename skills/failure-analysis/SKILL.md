...
- `/workspace/_context/failure-analysis-context.json` -- test metadata
- `/workspace/_context/test.log` -- the test log file

Read `/workspace/_context/failure-analysis-context.json` first. It contains:
...
1. **Read context first.** Load `/workspace/_context/failure-analysis-context.json` and extract the fields. The test log is at `/workspace/_context/test.log`.
