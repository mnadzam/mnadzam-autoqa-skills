...
- `/workspace/_context/matching-context.json` -- current analysis and historical tickets

Read `/workspace/_context/matching-context.json` first. It contains:
...
1. **Read context first.** Load `/workspace/_context/matching-context.json` and extract the current analysis and candidate tickets.
