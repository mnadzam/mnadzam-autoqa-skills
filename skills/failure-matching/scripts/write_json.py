...
# ]
# ///
"""Schema-validated JSON writer for structured agent output.
...
Reused from opendatahub-io/autofix-skills (Apache-2.0).
...
Usage:
    ...
    uv run --script write_json.py <schema> <output> --input <input>
