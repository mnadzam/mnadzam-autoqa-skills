...
- `/workspace/_context/false-alarm-context.json` -- test metadata
- `/workspace/_context/logs/` -- the test log file(s)

Read `/workspace/_context/false-alarm-context.json` first. It contains:
...
1. **Read context first.** Load `/workspace/_context/false-alarm-context.json` and extract the fields. Locate the test log file in `/workspace/_context/logs/`.
